...
Copyright © 2026 AlmanaX21 aka Kanishq. All Rights Reserved.

This project, including but not limited to all source code, compiled code, binaries, assets, textures, models, animations, sounds, music, configuration files, documentation, scripts, build files, metadata, branding, names, logos, icons, concepts, designs, and all other materials associated with or included iscollectively referred to as the “Mod”, is the exclusive property of AlmanaX21 aka Kanishq unless otherwise expressly stated in writing.

This Mod is proprietary software and proprietary creative work. It is not open source, not free software, not public domain, and not licensed for redistribution, modification, resale, reuse, repackaging, or derivative works.

## 1. Ownership

All rights, title, and interest in and to the Mod are retained exclusively by AlmanaX21 aka Kanishq.
...
No ownership rights are transferred to any user, downloader, contributor, server owner, modpack creator, marketplace, platform, distributor, or third party.
...
- Decompiled versions of the Mod
- Recompiled versions of the Mod
- Forks of the Mod
- Ports of the Mod
- Backports of the Mod
- Updated versions of the Mod
- Partial copies of the Mod
- Individual files from the Mod
- Assets extracted from the Mod
- Code extracted from the Mod
- Any derivative or adapted version of the Mod

## 4. Modpack and Add-on Permission
...
- Renaming the Mod
- Creating unofficial updates
- Creating compatibility forks
...
- Branding
- Promotional images
- Screenshots created for official presentation
- Any other visual, audio, or creative material
...
- Item logic
- GUI logic
- Any other implementation contained in the Mod
...
- Adaptations
- Expansions
- Add-ons based on copied code or assets
- Compatibility versions
- Unofficial continuations
- Unofficial updates
- Projects using extracted assets
...
By submitting any contribution, you represent that you have the legal right to submit it and that it does not infringe the rights of any third party.
...
This license does not grant any rights to third-party materials.
...
You may not use the name, branding, logos, or identity of the Mod in a way that suggests endorsement, affiliation, sponsorship, partnership, authorization, or official status without prior written permission from AlmanaX21 aka Kanishq.
...
All rights not expressly granted are reserved by AlmanaX21 aka Kanishq.

Access to the Mod, possession of a copy of the Mod, downloading the Mod, viewing the Mod, using the Mod, or receiving the Mod from any source does not grant any ownership interest or license beyond the limited permission expressly provided in this document.
...
AlmanaX21 aka Kanishq

Permission is valid only if granted in writing by AlmanaX21 aka Kanishq.

Verbal permission, informal discussion, comments, messages, assumptions, or lack of response do not constitute permission.
...
To the maximum extent permitted by law, AlmanaX21 aka Kanishq disclaims all warranties, including but not limited to warranties of merchantability, fitness for a particular purpose, non-infringement, compatibility, availability, accuracy, security, and error-free operation.
...
Any use not expressly permitted in writing by AlmanaX21 aka Kanishq is prohibited.
